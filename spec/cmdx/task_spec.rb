...
RSpec.describe CMDx::Task do
  ...
  describe ".call" do
    ...
    context "when calling with a Result object" do
      ...
      let(:source_result) { source_task.tap(&:process).result }
  ...
  describe "#perform!" do
    ...
    it "raises exceptions for failures" do
      ...
      expect { instance.process! }.to raise_error(CMDx::Failed)
    end
  ...
  describe "error handling" do
    ...
    it "propagates exceptions in perform!" do
      ...
      expect { instance.process! }.to raise_error(StandardError)
    end
  end
