  ...
  describe ".call" do
    context "with unmatched options" do
      ...
      it "raises an ArgumentError" do
        expect { validator }.to raise_error(ArgumentError, "no known numeric validator options given")
      end
    end
      ...
      context "when invalid" do
        ...
        context "with default message" do
          it "raises a ValidationError" do
            expect { validator }.to raise_error(CMDx::ValidationError, "must be at least 1")
          end
        end

        context "with custom message" do
          let(:options) do
            { numeric: { min: 1, message: "custom message %{min}" } }
          end
    ...
    context "with max option" do
      ...
      context "when invalid" do
        ...
        context "with default message" do
          it "raises a ValidationError" do
            expect { validator }.to raise_error(CMDx::ValidationError, "must be at most 5")
          end
        end

        context "with custom message" do
          let(:options) do
            { numeric: { max: 5, message: "custom message %{max}" } }
          end
    ...
    context "with min and max option" do
      ...
      context "when invalid" do
        ...
        context "with custom message" do
          let(:options) do
            { numeric: { min: 1, max: 5, message: "custom message %{min} and %{max}" } }
          end
    ...
    context "with within option" do
      ...
      context "when invalid" do
        ...
        context "with custom message" do
          let(:options) do
            { numeric: { within: (1..5), message: "custom message %{min} and %{max}" } }
          end
    ...
    context "with not within option" do
      ...
      context "when invalid" do
        ...
        context "with custom message" do
          let(:options) do
            { numeric: { not_within: (1..5), message: "custom message %{min} and %{max}" } }
          end
    ...
    context "with is option" do
      ...
      context "when invalid" do
        ...
        context "with custom message" do
          let(:options) do
            { numeric: { is: 5, message: "custom message %{is}" } }
          end
    ...
    context "with is not option" do
      ...
      context "when invalid" do
        ...
        context "with custom message" do
          let(:options) do
            { numeric: { is_not: 5, message: "custom message %{is_not}" } }
          end
