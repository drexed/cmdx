...
| Feature | [CMDx](https://github.com/drexed/cmdx) | [Actor](https://github.com/sunny/actor) | [Servactory](https://github.com/servactory/servactory) | [Interactor](https://github.com/collectiveidea/interactor) | [ActiveInteraction](https://github.com/AaronLasseigne/active_interaction) | [LightService](https://github.com/adomokos/light-service) |
|---------|------|-------|------------|------------|-------------------|--------------|
| Zero dependencies | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ |
| Typed attributes | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ |
| Type coercion | ✅ | ❌ | ✅ | ❌ | ✅ | ❌ |
