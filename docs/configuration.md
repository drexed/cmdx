...
Set the locale used for CMDx's built-in translation fallbacks when the `I18n` gem is not available. See [Internationalization](internationalization.md) for the full locale list.
