...
!!! warning "Surprise for newcomers"
...
- [Inputs — validations](../inputs/validations.md) — validators that fill `errors` for you.
- [Inputs — coercions](../inputs/coercions.md) — coercion failures show up here.
- [Outputs](../outputs.md) — output verification errors use the same bucket.
- [v1 → v2 migration](../v2-migration.md#errors) — what changed for `Errors` in 2.0.
