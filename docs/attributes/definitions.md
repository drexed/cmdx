...
!!! warning "Important"
    ...
    Attribute names that conflict with existing Ruby or CMDx methods will raise an error. Use `:as`, `:prefix`, or `:suffix` to resolve naming conflicts. See [Naming](naming.md).
