...
Formatter, level, and logger are set globally on `CMDx.configure` or per-task via `settings(...)`. See [Configuration - Logging](https://drexed.github.io/cmdx/configuration/index.md) for the full option list.
