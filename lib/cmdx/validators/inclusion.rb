  ...
  module Validators
    module Inclusion
      ...
      def raise_of_validation_error!(values, options)
        ...
        raise ValidationError, message || Utils::Locale.t("cmdx.validators.inclusion.of", values:)
      end
      ...
      def raise_within_validation_error!(min, max, options)
        ...
        raise ValidationError, message || Utils::Locale.t("cmdx.validators.inclusion.within", min:, max:)
      end
