  ...
  module Validators
    module Length
      ...
      def raise_within_validation_error!(min, max, options)
        ...
        raise ValidationError, message || Locale.translate!("cmdx.validators.length.within", min:, max:)
      end
      ...
      def raise_not_within_validation_error!(min, max, options)
        ...
        raise ValidationError, message || Locale.translate!("cmdx.validators.length.not_within", min:, max:)
      end
      ...
      def raise_min_validation_error!(min, options)
        ...
        raise ValidationError, message || Locale.translate!("cmdx.validators.length.min", min:)
      end
      ...
      def raise_is_validation_error!(is, options)
        ...
        raise ValidationError, message || Locale.translate!("cmdx.validators.length.is", is:)
      end
      ...
      def raise_is_not_validation_error!(is_not, options)
        ...
        raise ValidationError, message || Locale.translate!("cmdx.validators.length.is_not", is_not:)
      end
