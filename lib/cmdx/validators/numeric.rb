  ...
  module Validators
    module Numeric
      ...
      def raise_within_validation_error!(min, max, options)
        ...
        raise ValidationError, message || Utils::Locale.translate!("cmdx.validators.numeric.within", min:, max:)
      end
      ...
      def raise_not_within_validation_error!(min, max, options)
        ...
        raise ValidationError, message || Utils::Locale.translate!("cmdx.validators.numeric.not_within", min:, max:)
      end
      ...
      def raise_min_validation_error!(min, options)
        ...
        raise ValidationError, message || Utils::Locale.translate!("cmdx.validators.numeric.min", min:)
      end
      ...
      def raise_is_validation_error!(is, options)
        ...
        raise ValidationError, message || Utils::Locale.translate!("cmdx.validators.numeric.is", is:)
      end
      ...
      def raise_is_not_validation_error!(is_not, options)
        ...
        raise ValidationError, message || Utils::Locale.translate!("cmdx.validators.numeric.is_not", is_not:)
      end
