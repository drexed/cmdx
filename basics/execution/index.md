...
CMDx offers two execution methods with different error handling approaches. Choose based on your needs: safe result handling or exception-based control flow. See also [Result](https://drexed.github.io/cmdx/outcomes/result/index.md) for the full result API, [Halt](https://drexed.github.io/cmdx/interruptions/halt/index.md) for `skip!`/`fail!`, and [Retries](https://drexed.github.io/cmdx/retries/index.md) for automatic retry behavior.
